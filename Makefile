...
.PHONY: all conf_spire substation core spines prime scada_master benchmark conf_core conf_prime conf_scada_master libs openplc pvb iec clean_prime clean_libs clean_spire clean_substation clean
...
conf_core: spines conf_prime conf_scada_master benchmark
